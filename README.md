...
Шаблон объекта прав для view (объект прав обезательно содержит спец. команду '(all)'):
{_viewId:ассess}, где:
...
* read - объект содержащий в себе поля flexo c указанием доступа на чтение (обезательно содержит спец. команду '(all)')
* modify - объект содержащий в себе поля flexo c указанием доступа на модификацию (обезательно содержит спец. команду '(all)')
* create - объект содержащий в себе поля flexo c указанием доступа на создание (обезательно содержит спец. команду '(all)')
...
'''
   var obj = {
        type:'loss integrity', //Тип ошибки: нарушение целостности
