...
* object - объект с необходимыми аргументами
    ...
    * viewName - строка, имя view
* socket - объект сокета ( с прикрепленными login, role, userId, и разрешенными идентификатарами view )
...
* query - объект запрос
    * [user] - объект содержащий параметры поиска пользователя
        ...
        * [companiesWithRole] - строка, название роли, если задана то будет возвращен массив объектов c описанием связанных с этой ролью компаний
